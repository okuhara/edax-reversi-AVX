...
static unsigned short count_last_flip_A1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x0101010101010101ULL) * 0x0102040810204080ULL) >> 57];
	n_flipped += COUNT_FLIP_0[(P >> 1) & 0x7f];
	n_flipped += COUNT_FLIP_0[((P & 0x8040201008040200ULL) * 0x0101010101010101ULL) >> 57];
...
static unsigned short count_last_flip_B1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x0202020202020202ULL) * 0x0081020408102040ULL) >> 57];
	n_flipped += COUNT_FLIP_1[(P >> 2) & 0x3f];
	n_flipped += COUNT_FLIP_1[((P & 0x0080402010080400ULL) * 0x0101010101010101ULL) >> 58];
...
static unsigned short count_last_flip_C1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x0404040404040404ULL) * 0x0040810204081020ULL) >> 57];
...
static unsigned short count_last_flip_D1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x0808080808080808ULL) * 0x0020408102040810ULL) >> 57];
...
static unsigned short count_last_flip_E1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x1010101010101010ULL) * 0x0010204081020408ULL) >> 57];
...
static unsigned short count_last_flip_F1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x2020202020202020ULL) * 0x0008102040810204ULL) >> 57];
...
static unsigned short count_last_flip_G1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x4040404040404040ULL) * 0x0004081020408102ULL) >> 57];
	n_flipped += COUNT_FLIP_6[P & 0x3f];
	n_flipped += COUNT_FLIP_6[((P & 0x0001020408102000ULL) * 0x0101010101010101ULL) >> 56];
...
static unsigned short count_last_flip_H1(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_0[((P & 0x8080808080808080ULL) * 0x0002040810204081ULL) >> 57];
	n_flipped += COUNT_FLIP_7[P & 0x7f];
	n_flipped += COUNT_FLIP_7[((P & 0x0102040810204000ULL) * 0x0101010101010101ULL) >> 56];
...
static unsigned short count_last_flip_A2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x0101010101010101ULL) * 0x0102040810204080ULL) >> 58];
	n_flipped += COUNT_FLIP_0[(P >> 9) & 0x7f];
	n_flipped += COUNT_FLIP_1[((P & 0x4020100804020000ULL) * 0x0101010101010101ULL) >> 57];
...
static unsigned short count_last_flip_B2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x0202020202020202ULL) * 0x0081020408102040ULL) >> 58];
	n_flipped += COUNT_FLIP_1[(P >> 10) & 0x3f];
	n_flipped += COUNT_FLIP_1[((P & 0x8040201008040000ULL) * 0x0101010101010101ULL) >> 58];
...
static unsigned short count_last_flip_C2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x0404040404040404ULL) * 0x0040810204081020ULL) >> 58];
...
static unsigned short count_last_flip_D2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x0808080808080808ULL) * 0x0020408102040810ULL) >> 58];
...
static unsigned short count_last_flip_E2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x1010101010101010ULL) * 0x0010204081020408ULL) >> 58];
...
static unsigned short count_last_flip_F2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x2020202020202020ULL) * 0x0008102040810204ULL) >> 58];
...
static unsigned short count_last_flip_G2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x4040404040404040ULL) * 0x0004081020408102ULL) >> 58];
	n_flipped += COUNT_FLIP_6[(P >> 8) & 0x3f];
	n_flipped += COUNT_FLIP_6[((P & 0x0102040810200000ULL) * 0x0101010101010101ULL) >> 56];
...
static unsigned short count_last_flip_H2(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_1[((P & 0x8080808080808080ULL) * 0x0002040810204081ULL) >> 58];
	n_flipped += COUNT_FLIP_7[(P >> 8) & 0x7f];
	n_flipped += COUNT_FLIP_6[((P & 0x0204081020400000ULL) * 0x0101010101010101ULL) >> 57];
...
static unsigned short count_last_flip_A3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_0[(P >> 17) & 0x7f];
...
static unsigned short count_last_flip_B3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_1[(P >> 18) & 0x3f];
...
static unsigned short count_last_flip_C3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_52[((P & 0x0000000102000810ULL) * 0x0101000202000000ULL) >> 57];
...
static unsigned short count_last_flip_D3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_63[((P & 0x0000010204001020ULL) * 0x0101000202020000ULL) >> 57];
	n_flipped += COUNT_FLIP_72[((P & 0x0080402010000402ULL) * 0x0202000101010100ULL) >> 58];
...
static unsigned short count_last_flip_E3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_74[((P & 0x0001020408002040ULL) * 0x0101000202020200ULL) >> 57];
	n_flipped += COUNT_FLIP_62[((P & 0x0000804020000804ULL) * 0x0202000101010000ULL) >> 59];
...
static unsigned short count_last_flip_F3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_52[((P & 0x0000008040001008ULL) * 0x0202000101000000ULL) >> 60];
...
static unsigned short count_last_flip_G3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_6[(P >> 16) & 0x3f];
...
static unsigned short count_last_flip_H3(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_7[(P >> 16) & 0x7f];
...
static unsigned short count_last_flip_A4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_0[(P >> 25) & 0x7f];
...
static unsigned short count_last_flip_B4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_1[(P >> 26) & 0x3f];
...
static unsigned short count_last_flip_C4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_62[((P & 0x0000010200081020ULL) * 0x0101010002020000ULL) >> 57];
	n_flipped += COUNT_FLIP_72[((P & 0x4020100800020100ULL) * 0x0002020001010101ULL) >> 57];
...
static unsigned short count_last_flip_D4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_73[((P & 0x0001020400102040ULL) * 0x0101010002020200ULL) >> 57];
...
static unsigned short count_last_flip_E4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_73[((P & 0x0080402000080402ULL) * 0x0202020001010100ULL) >> 58];
...
static unsigned short count_last_flip_F4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_74[((P & 0x0204081000408000ULL) * 0x0001010002020202ULL) >> 58];
	n_flipped += COUNT_FLIP_63[((P & 0x0000804000100804ULL) * 0x0202020001010000ULL) >> 59];
...
static unsigned short count_last_flip_G4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_6[(P >> 24) & 0x3f];
...
static unsigned short count_last_flip_H4(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_7[(P >> 24) & 0x7f];
...
static unsigned short count_last_flip_A5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_0[(P >> 33) & 0x7f];
...
static unsigned short count_last_flip_B5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_1[(P >> 34) & 0x3f];
...
static unsigned short count_last_flip_C5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_72[((P & 0x0001020008102040ULL) * 0x0101010100020200ULL) >> 57];
	n_flipped += COUNT_FLIP_62[((P & 0x2010080002010000ULL) * 0x0000020200010101ULL) >> 57];
...
static unsigned short count_last_flip_D5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_73[((P & 0x4020100004020100ULL) * 0x0002020200010101ULL) >> 57];
...
static unsigned short count_last_flip_E5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_73[((P & 0x0204080020408000ULL) * 0x0001010100020202ULL) >> 58];
...
static unsigned short count_last_flip_F5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_63[((P & 0x0408100040800000ULL) * 0x0000010100020202ULL) >> 59];
	n_flipped += COUNT_FLIP_74[((P & 0x0080400010080402ULL) * 0x0202020200010100ULL) >> 58];
...
static unsigned short count_last_flip_G5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_6[(P >> 32) & 0x3f];
...
static unsigned short count_last_flip_H5(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_7[(P >> 32) & 0x7f];
...
static unsigned short count_last_flip_A6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_0[(P >> 41) & 0x7f];
...
static unsigned short count_last_flip_B6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_1[(P >> 42) & 0x3f];
...
static unsigned short count_last_flip_C6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_52[((P & 0x1008000201000000ULL) * 0x0000000202000101ULL) >> 57];
...
static unsigned short count_last_flip_D6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_72[((P & 0x0204001020408000ULL) * 0x0001010101000202ULL) >> 58];
	n_flipped += COUNT_FLIP_63[((P & 0x2010000402010000ULL) * 0x0000020202000101ULL) >> 57];
...
static unsigned short count_last_flip_E6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_62[((P & 0x0408002040800000ULL) * 0x0000010101000202ULL) >> 59];
	n_flipped += COUNT_FLIP_74[((P & 0x4020000804020100ULL) * 0x0002020202000101ULL) >> 57];
...
static unsigned short count_last_flip_F6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_52[((P & 0x0810004080000000ULL) * 0x0000000101000202ULL) >> 60];
...
static unsigned short count_last_flip_G6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_6[(P >> 40) & 0x3f];
...
static unsigned short count_last_flip_H6(const unsigned long long P)
{
	...
	n_flipped += COUNT_FLIP_7[(P >> 40) & 0x7f];
...
static unsigned short count_last_flip_A7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0101010101010101ULL) * 0x0102040810200000ULL) >> 56];
	n_flipped += COUNT_FLIP_0[(P >> 49) & 0x7f];
	n_flipped += COUNT_FLIP_1[((P & 0x0000020408102040ULL) * 0x0101010101010101ULL) >> 57];
...
static unsigned short count_last_flip_B7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000020202020202ULL) * 0x0081020408102040ULL) >> 56];
	n_flipped += COUNT_FLIP_1[(P >> 50) & 0x3f];
	n_flipped += COUNT_FLIP_1[((P & 0x0000040810204080ULL) * 0x0101010101010101ULL) >> 58];
...
static unsigned short count_last_flip_C7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000040404040404ULL) * 0x0040810204081020ULL) >> 56];
...
static unsigned short count_last_flip_D7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000080808080808ULL) * 0x0020408102040810ULL) >> 56];
...
static unsigned short count_last_flip_E7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000101010101010ULL) * 0x0010204081020408ULL) >> 56];
...
static unsigned short count_last_flip_F7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000202020202020ULL) * 0x0008102040810204ULL) >> 56];
...
static unsigned short count_last_flip_G7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000404040404040ULL) * 0x0004081020408102ULL) >> 56];
	n_flipped += COUNT_FLIP_6[(P >> 48) & 0x3f];
	n_flipped += COUNT_FLIP_6[((P & 0x0000201008040201ULL) * 0x0101010101010101ULL) >> 56];
...
static unsigned short count_last_flip_H7(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_6[((P & 0x0000808080808080ULL) * 0x0002040810204081ULL) >> 56];
	n_flipped += COUNT_FLIP_7[(P >> 48) & 0x7f];
	n_flipped += COUNT_FLIP_6[((P & 0x0000402010080402ULL) * 0x0101010101010101ULL) >> 57];
...
static unsigned short count_last_flip_A8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0101010101010101ULL) * 0x0102040810204000ULL) >> 56];
	n_flipped += COUNT_FLIP_0[P >> 57];
	n_flipped += COUNT_FLIP_0[((P & 0x0002040810204080ULL) * 0x0101010101010101ULL) >> 57];
...
static unsigned short count_last_flip_B8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0002020202020202ULL) * 0x0081020408102040ULL) >> 56];
	n_flipped += COUNT_FLIP_1[P >> 58];
	n_flipped += COUNT_FLIP_1[((P & 0x0004081020408000ULL) * 0x0101010101010101ULL) >> 58];
...
static unsigned short count_last_flip_C8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0004040404040404ULL) * 0x0040810204081020ULL) >> 56];
...
static unsigned short count_last_flip_D8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0008080808080808ULL) * 0x0020408102040810ULL) >> 56];
...
static unsigned short count_last_flip_E8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0010101010101010ULL) * 0x0010204081020408ULL) >> 56];
...
static unsigned short count_last_flip_F8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0020202020202020ULL) * 0x0008102040810204ULL) >> 56];
	n_flipped += COUNT_FLIP_5[P >> 56];
	n_flipped += COUNT_FLIP_5[(P & 0x2050880402010000ULL) * 0x0101010101010101ULL >> 56];	// A3F8H6
...
static unsigned short count_last_flip_G8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0040404040404040ULL) * 0x0004081020408102ULL) >> 56];
	n_flipped += COUNT_FLIP_6[(P >> 56) & 0x3f];
	n_flipped += COUNT_FLIP_6[((P & 0x0020100804020100ULL) * 0x0101010101010101ULL) >> 56];
...
static unsigned short count_last_flip_H8(const unsigned long long P)
{
	...
	n_flipped  = COUNT_FLIP_7[((P & 0x0080808080808080ULL) * 0x0002040810204081ULL) >> 56];
	n_flipped += COUNT_FLIP_7[(P >> 56) & 0x7f];
	n_flipped += COUNT_FLIP_7[((P & 0x0040201008040201ULL) * 0x0101010101010101ULL) >> 56];
