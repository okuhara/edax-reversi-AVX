...
# clang --target=aarch64-linux-gnu -std=c99 -pedantic -W -Wall -Wextra -pipe -D_GNU_SOURCE=1 -DUNICODE -Ofast -D NDEBUG -march=armv8.2-a+sve -flto all.c -s -o ../bin/lEdax-arm-sve -lm -lrt -lpthread
cd ../bin
...
# clang --target=aarch64-linux-gnu -std=c99 -pedantic -W -Wall -Wextra -pipe -D_GNU_SOURCE=1 -DUNICODE -Ofast -D NDEBUG -march=armv8-a -flto all.c -s -o ../bin/lEdax-arm -lm -lrt -lpthread
cd ../bin
