...
#define MOVE_GENERATOR_LZCNT 6
#define MOVE_GENERATOR_SSE 7		// 34.4Mnps	// best for generic X86-64
#define MOVE_GENERATOR_SSE_ACEPCK 8
#define MOVE_GENERATOR_AVX 9		// 34.7Mnps	// best for X86-64-v3
#define MOVE_GENERATOR_AVXGFNI	10
#define MOVE_GENERATOR_AVX512 11
#define MOVE_GENERATOR_NEON 12				// 31.0Mnps@armv8
#define MOVE_GENERATOR_SVE 13
...
#define COUNT_LAST_FLIP_BMI2 7		// SIMULLASTFLIP	// 34.7Mnps	// slow on old AMD
