...
#define MOVE_GENERATOR_SSE 6		// 34.4Mnps	// best for generic X86-64
#define MOVE_GENERATOR_SSE_ACEPCK 7
#define MOVE_GENERATOR_AVX 8		// 34.7Mnps	// best for X86-64-v3
#define MOVE_GENERATOR_AVXGFNI	9
#define MOVE_GENERATOR_AVX512 10
#define MOVE_GENERATOR_NEON 11				// 31.0Mnps@armv8
#define MOVE_GENERATOR_SVE 12
