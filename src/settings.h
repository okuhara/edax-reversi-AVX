...
#define COUNT_LAST_FLIP_AVX_PPFILL 8	// LASTFLIP_HIGHCUT / LASTFLIP_LOWCUT
#define COUNT_LAST_FLIP_AVX512 9	// SIMULLASTFLIP512 / SIMULLASTFLIP / LASTFLIP_HIGHCUT / LASTFLIP_LOWCUT
#define COUNT_LAST_FLIP_NEON 10		// LASTFLIP_LOWCUT			// 31.0Mnps@armv8
#define COUNT_LAST_FLIP_SVE 11		// LASTFLIP_LOWCUT / SIMULLASTFLIP
